...
*/ (function () {
        ...
        "./node_modules/core-js/internals/define-iterator.js": function (
          ...
          s.exports = function ($, H, ue, yt, Te, rn, Nt) {
            ...
            if (
              ...
              else l({ target: H, proto: !0, forced: T || Qe }, Se);
            return Se;
          };
        },
   ...
   */ (function (U, k) {
    (function (s, f) {
      ...
      const s = new Map(),
        ...
        Oe = {};
      let mt = 1;
      const Qe = { mouseenter: "mouseover", mouseleave: "mouseout" },
        le = new Set([
          "click",
          "dblclick",
          "mouseup",
      ...
      const x = {
        ...
        off(n, e, t, i) {
          ...
          if (j) for (const I of Object.keys(b)) Nr(n, b, I, e.slice(1));
          for (const [I, P] of Object.entries(M)) {
            const N = I.replace(Nt, "");
            (!y || e.includes(N)) &&
              Ze(n, b, d, P.callable, P.delegationSelector);
          }
        },
        trigger(n, e, t) {
          ...
          const j = on(new Event(e, { bubbles: y, cancelable: !0 }), t);
          return (
            M && j.preventDefault(),
            b && n.dispatchEvent(j),
      ...
      class xt extends he {
        ...
        toggle() {
          this._element.setAttribute(
            "aria-pressed",
            this._element.classList.toggle(zr)
          );
        }
        static jQueryInterface(e) {
          return this.each(function () {
      ...
      const Kr = "swipe",
        ...
        Zr = "pointer-event",
        Jr = 40,
        qr = { endCallback: null, leftCallback: null, rightCallback: null },
        eo = {
      ...
      class It extends gt {
        ...
        _initEvents() {
          this._supportPointerEvents
            ...
            : (x.on(this._element, Wr, (e) => this._start(e)),
        ...
        _eventIsPointerPenTouch(e) {
          return (
            this._supportPointerEvents &&
            (e.pointerType === Qr || e.pointerType === Xr)
          );
        }
        static isSupported() {
          return (
      ...
      class tt extends he {
        ...
        _addEventListeners() {
          this._config.keyboard &&
            x.on(this._element, so, (e) => this._keydown(e)),
            this._config.pause === "hover" &&
              (x.on(this._element, ao, () => this.pause()),
      ...
      const To = "collapse",
        ...
        Ho = { parent: null, toggle: !0 },
        ko = { parent: "(null|element)", toggle: "boolean" };
      class it extends he {
        constructor(e, t) {
        ...
        show() {
          ...
          if (
            (this._config.parent &&
              (e = this._getFirstLevelChildren(Vo)
                .filter((y) => y !== this._element)
                .map((y) => it.getOrCreateInstance(y, { toggle: !1 }))),
            (e.length && e[0]._isTransitioning) ||
              x.trigger(this._element, So).defaultPrevented)
          )
            return;
        ...
        hide() {
          if (
            ...
            !this._isShown() ||
            x.trigger(this._element, Co).defaultPrevented
          )
            return;
        ...
        _addAriaAndCollapsedClass(e, t) {
          if (e.length)
            for (const i of e)
              i.classList.toggle(Do, !t), i.setAttribute("aria-expanded", t);
        }
        static jQueryInterface(e) {
          const t = {};
          return (
      ...
      function lt(n, e, t) {
        ...
        e &&
          ce(n) &&
          ((o = (n.offsetWidth > 0 && at(i.width) / n.offsetWidth) || 1),
      ...
      function kt(n) {
        return ve(n) === "html"
          ? n
          : n.assignedSlot || n.parentNode || (fn(n) ? n.host : null) || Ce(n);
      }
      function fi(n) {
      ...
      function Qo(n, e) {
        ...
        return { x: at(t * o) / o || 0, y: at(i * o) / o || 0 };
      }
      function xi(n) {
        var e,
          t = n.popper,
          ...
          B = d.y,
          R = B === void 0 ? 0 : B,
          z = typeof j == "function" ? j({ x: N, y: R }) : { x: N, y: R };
        (N = z.x), (R = z.y);
        ...
        var ee = Object.assign({ position: y }, M && Xo),
          ye = j === !0 ? Qo({ x: N, y: R }, se(t)) : { x: N, y: R };
        if (((N = ye.x), (R = ye.y), b)) {
          var ie;
      ...
      function ts(n, e) {
        ...
        return { width: c, height: d, x: y + bn(n), y: b };
      }
      function ns(n) {
        var e,
          t = Ce(n),
        ...
        if (!e.modifiersData[i]._skip) {
          for (
            var o = t.mainAxis,
              ...
              z = e.options.placement,
              Y = xe(z),
              X = Y === z,
              Q = b || (X || !B ? [Ft(z)] : as(z)),
              V = [z].concat(Q).reduce(function (ht, Le) {
                return ht.concat(
                  xe(Le) === Vt
                    ? ss(e, {
                        placement: Le,
      ...
      function cs(n) {
        var e = n.state,
          ...
          d = dt(e, { elementContext: "reference" }),
          y = dt(e, { altBoundary: !0 }),
          b = wi(d, i),
          M = wi(y, o, c),
          j = Ti(b),
          I = Ti(M);
        ...
        if (K) {
          if (c) {
            var ie,
              ...
              St = X === Ie ? -q[ae] : -G[ae],
              qt = e.elements.arrow,
              ht = N && qt ? gn(qt) : { width: 0, height: 0 },
      ...
      function vs(n, e, t) {
        ...
        return (
          (i || (!i && !t)) &&
            ((ve(e) !== "body" || An(c)) && (y = ms(e)),
            ce(e)
              ? ((b = lt(e, !0)), (b.x += e.clientLeft), (b.y += e.clientTop))
              : c && (b.x = bn(c))),
          {
          ...
          var j = {
            ...
            N = {
              ...
              setOptions: function (Y) {
                ...
                return (
                  (j.orderedModifiers = Q.filter(function (V) {
                    return V.enabled;
                  })),
                  B(),
                  N.update()
          ...
          function B() {
            j.orderedModifiers.forEach(function (z) {
              ...
              if (typeof V == "function") {
                var F = V({ state: j, name: Y, instance: N, options: Q }),
                  K = function () {};
                I.push(F || K);
              }
            });
      ...
      var As = Kt(),
        js = [_n, wn, xn, yn],
        ws = Kt({ defaultModifiers: js }),
        Ts = [_n, wn, xn, yn, Si, ji, Mi, vi, Oi],
        Tn = Kt({ defaultModifiers: Ts });
      ...
      const ia = "focustrap",
        ...
        aa = "forward",
        Fi = "backward",
        la = { autofocus: !0, trapElement: null },
        ca = { autofocus: "boolean", trapElement: "element" };
      class Ki extends gt {
        constructor(e) {
          super(),
            (this._config = this._getConfig(e)),
      ...
      const da = "modal",
        ...
        Ta = { backdrop: !0, focus: !0, keyboard: !0 },
        Oa = {
      ...
      class He extends he {
        ...
        hide() {
          !this._isShown ||
            this._isTransitioning ||
            x.trigger(this._element, ha).defaultPrevented ||
            ((this._isShown = !1),
            (this._isTransitioning = !0),
        ...
        _showElement(e) {
          ...
          const i = () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              x.trigger(this._element, ya, { relatedTarget: e });
          };
      ...
      class we extends he {
        ...
        show(e) {
          if (
            this._isShown ||
            x.trigger(this._element, La, { relatedTarget: e }).defaultPrevented
          )
            return;
          (this._isShown = !0),
            this._backdrop.show(),
          ...
          const i = () => {
            (!this._config.scroll || this._config.backdrop) &&
              ...
              this._element.classList.remove(qi),
              x.trigger(this._element, Da, { relatedTarget: e });
          };
          this._queueCallback(i, this._element, !0);
        }
        hide() {
      ...
      class Xa extends gt {
        ...
        _checkContent(e) {
          for (const [t, i] of Object.entries(e))
            super._typeCheckConfig({ selector: t, entry: i }, Ua);
        }
        _setContent(e, t, i) {
        ...
        _maybeSanitize(e) {
          return this._config.sanitize
            ? Wa(e, this._config.allowList, this._config.sanitizeFn)
            : e;
        }
            ...
            if (t === "click")
              ...
              x.on(this._element, i, this._config.selector, (c) => {
                ...
                x.on(this._element, o, this._config.selector, (c) => {
                  const d = this._initializeOnDelegatedTarget(c);
                  (d._activeTrigger[c.type === "focusout" ? Nn : wt] =
      ...
      const yl = "popover",
        ...
        xl = { ...ke.DefaultType, content: "(null|string|element|function)" };
      class Ut extends ke {
        static get Default() {
          return vl;
        }
        ...
        _getContentForTemplate() {
          return { [ml]: this._getTitle(), [gl]: this._getContent() };
        }
        _getContent() {
      ...
      class Tt extends he {
        ...
        _process(e) {
          this._activeTarget !== e &&
            ...
            x.trigger(this._element, bl, { relatedTarget: e }));
        }
        _activateParents(e) {
      ...
      class Ke extends he {
        ...
        show() {
          ...
          const t = this._getActiveElem(),
            i = t ? x.trigger(t, Dl, { relatedTarget: e }) : null;
          x.trigger(e, $l, { relatedTarget: t }).defaultPrevented ||
        ...
        _activate(e, t) {
          ...
          const i = () => {
            ...
            e.removeAttribute("tabindex"),
              ...
              x.trigger(e, Pl, { relatedTarget: t });
          };
        ...
        _deactivate(e, t) {
          ...
          const i = () => {
            ...
            e.setAttribute("aria-selected", !1),
              ...
              x.trigger(e, Il, { relatedTarget: t });
          };
          this._queueCallback(i, e, e.classList.contains(pr));
        }
        _keydown(e) {
      ...
      const Ul = "toast",
        ...
        oc = { animation: !0, autohide: !0, delay: 5e3 };
      class Ot extends he {
        constructor(e, t) {
          super(e, t),
            (this._timeout = null),
  ...
  class Mr {
    constructor(k, s = {}) {
      (this.sidebarEL =
        k instanceof HTMLElement ? k : document.querySelector(k)),
        (this.options = s),
        this.init();
    }
    init() {
      ...
      if (typeof PerfectScrollbar == "function") {
        ...
        new PerfectScrollbar(r, { wheelPropagation: !0 });
      }
      setTimeout(() => {
    ...
    toggleOverflowBody(k) {
      ...
      typeof k > "u"
        ...
        : (f.style.overflowY = k ? "auto" : "hidden");
    }
  ...
  const Bn = (U) => {
      if (!Xe) return;
      Ct(window) &&
        (U.classList.add("active"), U.classList.add("sidebar-desktop"));
  ...
  document.readyState !== "loading"
    ? Bn(Xe)
    : window.addEventListener("DOMContentLoaded", () => Bn(Xe)),
    (window.Sidebar = Mr),
